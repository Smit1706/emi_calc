...
type RdResultScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'RdResult'>;
type RdResultScreenRouteProp = RouteProp<RootStackParamList, 'RdResult'>;

export const RdResultScreen: React.FC = memo(() => {
    const navigation = useNavigation<RdResultScreenNavigationProp>();
    const route = useRoute<RdResultScreenRouteProp>();
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.headerRow}>
                    ...
                    <View style={styles.headerCenter}>
                        <Text style={styles.title}>RD Result</Text>
            ...
            >
                ...
                <View style={styles.detailsCard}>
                    <Text style={styles.detailsTitle}>RD Details</Text>
                    <View style={styles.detailsRow}>
                        <Text style={styles.detailsLabel}>Monthly Deposit</Text>
                        <Text style={styles.detailsValue}>{formatCurrency(monthlyDeposit)}</Text>
                    </View>
                    <View style={styles.detailsRow}>
                ...
                <View style={styles.ctaContainer}>
                    <TouchableOpacity
                        ...
                        activeOpacity={0.8}
                    >
                        <Text style={styles.primaryButtonText}>Compare Another RD</Text>
                    </TouchableOpacity>
